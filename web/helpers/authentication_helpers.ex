defmodule NationalVoterFile.AuthenticationHelpers do
  ...
  def handle_unauthorized(conn = %{assigns: %{authorized: false}}) do
    conn
    |> put_status(403)
    |> render(NationalVoterFile.TokenView, "403.json", message: "You are not authorized to perform this action.")
    |> halt
  end
  ...
  def handle_not_found(conn) do
    ...
    |> render(NationalVoterFile.ErrorView, "404.json")
    |> halt
  end
